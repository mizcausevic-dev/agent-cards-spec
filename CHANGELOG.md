...
### Released
- Published **agent-cards-spec** as a public, portfolio-grade platform governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **agent-cards-spec**.
...
- That insight became the basis for **agent-cards-spec**.
